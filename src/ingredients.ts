export const ingredients = [
    ...
    {
      "name": "Scotch",
      "description": "Scotch Whiskey, often simply called Scotch, is malt Whiskey or grain Whiskey made in Scotland. Scotch Whiskey must be made in a manner specified by law.\n\nAll Scotch Whiskey was originally made from malted barley. Commercial distilleries began introducing Whiskey made from wheat and rye in the late 18th century.[2] Scotch Whiskey is divided into five distinct categories: single malt Scotch Whiskey, single grain Scotch Whiskey, blended malt Scotch Whiskey (formerly called \"vatted malt\" or \"pure malt\"), blended grain Scotch Whiskey, and blended Scotch Whiskey.\n\nAll Scotch Whiskey must be aged in oak barrels for at least three years. Any age statement on a bottle of Scotch Whiskey, expressed in numerical form, must reflect the age of the youngest Whiskey used to produce that product. A Whiskey with an age statement is known as guaranteed-age Whiskey.\n\nThe first written mention of Scotch Whiskey is in the Exchequer Rolls of Scotland, 1495. A friar named John Cor was the distiller at Lindores Abbey in the Kingdom of Fife.\n\nMany Scotch Whiskey drinkers will refer to a unit for drinking as a dram.",
      "type": "Whiskey",
      "isAlcoholic": true,
      "abv": ""
    },
    ...
    {
      "name": "Basil",
      "description": "Basil, also called great basil, is a culinary herb of the family Lamiaceae (mints). It is a tender plant, and is used in cuisines worldwide. In Western cuisine, the generic term \"basil\" refers to the variety also known as sweet basil or Genovese basil.",
      "type": "Garnish",
      "isAlcoholic": false,
      "abv": ""
    },
    ...
    {
      "name": "Cola",
      "description": "Cola is a sweetened, carbonated soft drink flavored with vanilla, cinnamon, citrus oils and other flavorings. Most contain caffeine, which was originally sourced from the kola nut, leading to the drink's name, though other sources are now also used.",
      "type": "Soft Drink",
      "isAlcoholic": false,
      "abv": 0
    },
    ...
    {
      "name": "Hawaiian Punch",
      "description": "Hawaiian Punch is made with natural fruit juices and flavors, including such tropical favorites as pineapple, passion fruit, papaya, and guava.",
      "type": "Soda",
      "isAlcoholic": false,
      "abv": ""
    },
    {
      ...
      "description": "Frangelico is a premium Italian liqueur distilled from locally-grown hazelnuts and blended with coffee, cocoa and vanilla distillate.",
      "type": "Liquer",
      "isAlcoholic": true,
      "abv": ""
    },
    ...
    {
      "name": "Hooch",
      "description": "Hooper's Hooch is an alcopop that was most popular during the mid-1990s. The name Hoopers refers to William Hooper, inventor of the hot water bottle and manufacturer of lemonade in the 1840s whose trademark was owned by Burton-on-Trent-based brewer Bass.",
      "type": "Alcopop",
      "isAlcoholic": true,
      "abv": ""
    },
    ...
    },
    {
      ...
      "description": "Light, elegant cream liqueur with the flair of white chocolate. Aromatic vanilla, delicious caramel, fresh cream, warm overtones of white chocolate.",
      "type": "Liquer",
      "isAlcoholic": true,
      "abv": ""
    },
    ...
    },
    {
      ...
      "description": "An unaged mezcal from Ilegal, originally produced for the Café no Sé in Guatemala and thankfully now making its way out into the wider world.",
      "type": "Spirit",
      "isAlcoholic": true,
      "abv": ""
    },
    ...
    },
    {
      ...
      "description": "Cocchi Americano (Pronounced: ˈkɔkki ameriˈkano) is a quinine-laced aperitif wine produced by Giulio Cocchi Spumanti in the Asti province of Italy. Cocchi Americano is a variety of Americano. The wine was developed by Giulio Cocchi, and production began in 1891. Cocchi also produces a pink variety of this aperitif, the \"Cocchi Americano Rosa\", which is slightly more bitter and aromatic than the classic white Cocchi Americano.",
      "type": "Aperitif",
      "isAlcoholic": true,
      "abv": ""
    },
    ...
    {
      "name": "Ramazzotti",
      "description": "Ramazzotti is an Italian digestivo bitter liqueur Amaro, bottled at 30% alcohol by volume. It is bottled in Milan by Pernod Ricard.",
      "type": "Liqueur",
      "isAlcoholic": true,
      "abv": ""
    },
    {
      "name": "Fernet-branca",
      "description": "Fernet-Branca [ferˈnɛt ˈbraŋka] is a brand of amaro, or bitter herbal liqueur. Bernandino Branca invented the Fernet-Branca bitter in Milan, Italy, in 1845. The brand soon thereafter gained popularity, leading to the founding of the Fratelli Branca Distillery.",
      "type": "Liqueur",
      "isAlcoholic": true,
      "abv": ""
    },
    {
      "name": "Allspice Dram",
      "description": "Allspice, also called pimenta, Jamaica pimenta, or myrtle pepper is the dried unripe fruit (berries, used as a spice) of Pimenta dioica, a midcanopy tree native to the Greater Antilles, southern Mexico, and Central America, now cultivated in many warm parts of the world.[2] The name \"allspice\" was coined as early as 1621 by the English, who thought it combined the flavour of cinnamon, nutmeg, and cloves.",
      "type": "Liquer",
      "isAlcoholic": true,
      "abv": ""
    },
    ...
    {
      "name": "Blended Scotch",
      "description": "Scotch Whiskey (Scottish Gaelic: uisge-beatha na h-Alba; often simply called Scotch) is malt Whiskey or grain Whiskey made in Scotland. Scotch Whiskey must be made in a manner specified by law.\n\nAll Scotch Whiskey was originally made from malted barley. Commercial distilleries began introducing Whiskey made from wheat and rye in the late 18th century.[2] Scotch Whiskey is divided into five distinct categories: single malt Scotch Whiskey, single grain Scotch Whiskey, blended malt Scotch Whiskey (formerly called \"vatted malt\" or \"pure malt\"), blended grain Scotch Whiskey, and blended Scotch Whiskey.",
      "type": "Whiskey",
      "isAlcoholic": true,
      "abv": ""
    },
    ...
    {
      "name": "Chareau",
      "description": "Chareau is an eau de vie from California, a light, clear brandy made from aloe vera",
      "type": "Brandy",
      "isAlcoholic": true,
      "abv": 25
    },
    {
      ...
      "description": "Fireball Cinnamon Whiskey is a mixture of Canadian Whiskey, cinnamon flavoring and sweeteners that is produced by the Sazerac Company. As of 2018, Fireball is among the top selling Whiskey brands in the United States. Its foundation is Canadian Whiskey, and the taste otherwise resembles the candy with a similar name, Ferrara Candy Company's \"Atomic Fireball\" candy. It is bottled at 33% alcohol by volume (66 U.S. proof).\n\nAccording to the official Fireball website, the product was developed in Canada in the mid-1980s, and for a long time was little known outside of Canada. In addition to the United States and Canada, Fireball is now also available in other countries.",
      "type": "Whiskey",
      "isAlcoholic": true,
      "abv": 33
    },
    {
      "name": "Red Bull",
      "description": "Red Bull is an energy drink sold by Red Bull GmbH, an Austrian company created in 1987. Red Bull has the highest market share of any energy drink in the world, with 7.5 billion cans sold in a year.",
      "type": "Soda",
      "isAlcoholic": false,
      "abv": 0
    },
